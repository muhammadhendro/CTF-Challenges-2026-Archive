...
if  x = number of times scientist was cited in 2013
y = page range of the paper published in the larger volume 
c = name of conference
p = city where the conference was held that year
